...
<head>
    ...
    <link rel="shortcut icon" href="assets/kclogo.png" type="image/x-icon">
    <link rel="shortcut icon" href="/assets/kch-icon.png" type="image/x-icon">
    <link rel="stylesheet" href="/css/dashboard-employee.css">
    <!--CSS-->
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            function fetchMessages() {
                $.ajax({
                    type: 'get',
                    url: '/employee/message/' + receiver_id,
                    success: function(data) {
                        $("#messages").html(data);
